...
part 'v0041_openapi_accounts_resp.g.dart';
...
@BuiltValue()
abstract class V0041OpenapiAccountsResp implements Built<V0041OpenapiAccountsResp, V0041OpenapiAccountsRespBuilder> {
  /// accounts
  ...
  V0041OpenapiAccountsResp._();

  factory V0041OpenapiAccountsResp([void updates(V0041OpenapiAccountsRespBuilder b)]) = _$V0041OpenapiAccountsResp;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041OpenapiAccountsRespBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041OpenapiAccountsResp> get serializer => _$V0041OpenapiAccountsRespSerializer();
}

class _$V0041OpenapiAccountsRespSerializer implements PrimitiveSerializer<V0041OpenapiAccountsResp> {
  @override
  final Iterable<Type> types = const [V0041OpenapiAccountsResp, _$V0041OpenapiAccountsResp];

  @override
  final String wireName = r'V0041OpenapiAccountsResp';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041OpenapiAccountsResp object, {
  ...
  void _deserializeProperties(
    ...
    required V0041OpenapiAccountsRespBuilder result,
  ...
  @override
  V0041OpenapiAccountsResp deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041OpenapiAccountsRespBuilder();
