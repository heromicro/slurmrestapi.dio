...
part 'v0041_openapi_resp.g.dart';
...
@BuiltValue()
abstract class V0041OpenapiResp implements Built<V0041OpenapiResp, V0041OpenapiRespBuilder> {
  ...
  factory V0041OpenapiResp([void updates(V0041OpenapiRespBuilder b)]) = _$V0041OpenapiResp;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041OpenapiRespBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041OpenapiResp> get serializer => _$V0041OpenapiRespSerializer();
}

class _$V0041OpenapiRespSerializer implements PrimitiveSerializer<V0041OpenapiResp> {
  @override
  final Iterable<Type> types = const [V0041OpenapiResp, _$V0041OpenapiResp];

  @override
  final String wireName = r'V0041OpenapiResp';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041OpenapiResp object, {
  ...
  void _deserializeProperties(
    ...
    required V0041OpenapiRespBuilder result,
  ...
  @override
  V0041OpenapiResp deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041OpenapiRespBuilder();
