...
part 'dbv0037_association_usage.g.dart';
...
@BuiltValue()
abstract class Dbv0037AssociationUsage implements Built<Dbv0037AssociationUsage, Dbv0037AssociationUsageBuilder> {
  ...
  Dbv0037AssociationUsage._();

  factory Dbv0037AssociationUsage([void updates(Dbv0037AssociationUsageBuilder b)]) = _$Dbv0037AssociationUsage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(Dbv0037AssociationUsageBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Dbv0037AssociationUsage> get serializer => _$Dbv0037AssociationUsageSerializer();
}

class _$Dbv0037AssociationUsageSerializer implements PrimitiveSerializer<Dbv0037AssociationUsage> {
  @override
  final Iterable<Type> types = const [Dbv0037AssociationUsage, _$Dbv0037AssociationUsage];

  @override
  final String wireName = r'Dbv0037AssociationUsage';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    Dbv0037AssociationUsage object, {
  ...
  void _deserializeProperties(
    ...
    required Dbv0037AssociationUsageBuilder result,
  ...
  @override
  Dbv0037AssociationUsage deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = Dbv0037AssociationUsageBuilder();
