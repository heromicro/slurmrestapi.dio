...
part 'v0041_kill_jobs_msg.g.dart';
...
@BuiltValue()
abstract class V0041KillJobsMsg implements Built<V0041KillJobsMsg, V0041KillJobsMsgBuilder> {
  ...
  BuiltList<V0041KillJobsMsgFlagsEnum>? get flags;
  // enum flagsEnum {  BATCH_JOB,  ARRAY_TASK,  FULL_STEPS_ONLY,  FULL_JOB,  FEDERATION_REQUEUE,  HURRY,  OUT_OF_MEMORY,  NO_SIBLING_JOBS,  RESERVATION_JOB,  VERBOSE,  CRON_JOBS,  WARNING_SENT,  };
  ...
  factory V0041KillJobsMsg([void updates(V0041KillJobsMsgBuilder b)]) = _$V0041KillJobsMsg;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041KillJobsMsgBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041KillJobsMsg> get serializer => _$V0041KillJobsMsgSerializer();
}

class _$V0041KillJobsMsgSerializer implements PrimitiveSerializer<V0041KillJobsMsg> {
  @override
  final Iterable<Type> types = const [V0041KillJobsMsg, _$V0041KillJobsMsg];

  @override
  final String wireName = r'V0041KillJobsMsg';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041KillJobsMsg object, {
    ...
    if (object.flags != null) {
      ...
      yield serializers.serialize(
        object.flags,
        specifiedType: const FullType(BuiltList, [FullType(V0041KillJobsMsgFlagsEnum)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required V0041KillJobsMsgBuilder result,
      ...
      switch (key) {
        ...
        case r'flags':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(V0041KillJobsMsgFlagsEnum)]),
          ) as BuiltList<V0041KillJobsMsgFlagsEnum>;
  ...
  @override
  V0041KillJobsMsg deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041KillJobsMsgBuilder();
...
class V0041KillJobsMsgFlagsEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'BATCH_JOB')
  static const V0041KillJobsMsgFlagsEnum BATCH_JOB = _$v0041KillJobsMsgFlagsEnum_BATCH_JOB;
  @BuiltValueEnumConst(wireName: r'ARRAY_TASK')
  static const V0041KillJobsMsgFlagsEnum ARRAY_TASK = _$v0041KillJobsMsgFlagsEnum_ARRAY_TASK;
  @BuiltValueEnumConst(wireName: r'FULL_STEPS_ONLY')
  static const V0041KillJobsMsgFlagsEnum FULL_STEPS_ONLY = _$v0041KillJobsMsgFlagsEnum_FULL_STEPS_ONLY;
  @BuiltValueEnumConst(wireName: r'FULL_JOB')
  static const V0041KillJobsMsgFlagsEnum FULL_JOB = _$v0041KillJobsMsgFlagsEnum_FULL_JOB;
  @BuiltValueEnumConst(wireName: r'FEDERATION_REQUEUE')
  static const V0041KillJobsMsgFlagsEnum FEDERATION_REQUEUE = _$v0041KillJobsMsgFlagsEnum_FEDERATION_REQUEUE;
  @BuiltValueEnumConst(wireName: r'HURRY')
  static const V0041KillJobsMsgFlagsEnum HURRY = _$v0041KillJobsMsgFlagsEnum_HURRY;
  @BuiltValueEnumConst(wireName: r'OUT_OF_MEMORY')
  static const V0041KillJobsMsgFlagsEnum OUT_OF_MEMORY = _$v0041KillJobsMsgFlagsEnum_OUT_OF_MEMORY;
  @BuiltValueEnumConst(wireName: r'NO_SIBLING_JOBS')
  static const V0041KillJobsMsgFlagsEnum NO_SIBLING_JOBS = _$v0041KillJobsMsgFlagsEnum_NO_SIBLING_JOBS;
  @BuiltValueEnumConst(wireName: r'RESERVATION_JOB')
  static const V0041KillJobsMsgFlagsEnum RESERVATION_JOB = _$v0041KillJobsMsgFlagsEnum_RESERVATION_JOB;
  @BuiltValueEnumConst(wireName: r'VERBOSE')
  static const V0041KillJobsMsgFlagsEnum VERBOSE = _$v0041KillJobsMsgFlagsEnum_VERBOSE;
  @BuiltValueEnumConst(wireName: r'CRON_JOBS')
  static const V0041KillJobsMsgFlagsEnum CRON_JOBS = _$v0041KillJobsMsgFlagsEnum_CRON_JOBS;
  @BuiltValueEnumConst(wireName: r'WARNING_SENT')
  static const V0041KillJobsMsgFlagsEnum WARNING_SENT = _$v0041KillJobsMsgFlagsEnum_WARNING_SENT;

  static Serializer<V0041KillJobsMsgFlagsEnum> get serializer => _$v0041KillJobsMsgFlagsEnumSerializer;

  const V0041KillJobsMsgFlagsEnum._(String name): super(name);

  static BuiltSet<V0041KillJobsMsgFlagsEnum> get values => _$v0041KillJobsMsgFlagsEnumValues;
  static V0041KillJobsMsgFlagsEnum valueOf(String name) => _$v0041KillJobsMsgFlagsEnumValueOf(name);
}
