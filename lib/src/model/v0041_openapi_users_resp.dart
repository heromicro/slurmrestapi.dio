...
part 'v0041_openapi_users_resp.g.dart';
...
@BuiltValue()
abstract class V0041OpenapiUsersResp implements Built<V0041OpenapiUsersResp, V0041OpenapiUsersRespBuilder> {
  /// users
  ...
  V0041OpenapiUsersResp._();

  factory V0041OpenapiUsersResp([void updates(V0041OpenapiUsersRespBuilder b)]) = _$V0041OpenapiUsersResp;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041OpenapiUsersRespBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041OpenapiUsersResp> get serializer => _$V0041OpenapiUsersRespSerializer();
}

class _$V0041OpenapiUsersRespSerializer implements PrimitiveSerializer<V0041OpenapiUsersResp> {
  @override
  final Iterable<Type> types = const [V0041OpenapiUsersResp, _$V0041OpenapiUsersResp];

  @override
  final String wireName = r'V0041OpenapiUsersResp';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041OpenapiUsersResp object, {
  ...
  void _deserializeProperties(
    ...
    required V0041OpenapiUsersRespBuilder result,
  ...
  @override
  V0041OpenapiUsersResp deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041OpenapiUsersRespBuilder();
