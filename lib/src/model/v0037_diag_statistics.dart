...
part 'v0037_diag_statistics.g.dart';
...
@BuiltValue()
abstract class V0037DiagStatistics implements Built<V0037DiagStatistics, V0037DiagStatisticsBuilder> {
  ...
  V0037DiagStatistics._();

  factory V0037DiagStatistics([void updates(V0037DiagStatisticsBuilder b)]) = _$V0037DiagStatistics;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0037DiagStatisticsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0037DiagStatistics> get serializer => _$V0037DiagStatisticsSerializer();
}

class _$V0037DiagStatisticsSerializer implements PrimitiveSerializer<V0037DiagStatistics> {
  @override
  final Iterable<Type> types = const [V0037DiagStatistics, _$V0037DiagStatistics];

  @override
  final String wireName = r'V0037DiagStatistics';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0037DiagStatistics object, {
  ...
  void _deserializeProperties(
    ...
    required V0037DiagStatisticsBuilder result,
  ...
  @override
  V0037DiagStatistics deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0037DiagStatisticsBuilder();
