...
import 'package:slurmrestapi/src/model/v0040_acct_gather_energy.dart';
import 'package:built_value/json_object.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'v0040_node.g.dart';
...
@BuiltValue()
abstract class V0040Node implements Built<V0040Node, V0040NodeBuilder> {
  ...
  V0040AcctGatherEnergy? get energy;
  ...
  V0040Uint64NoVal? get reasonChangedAt;
  ...
  V0040Uint64NoVal? get resumeAfter;
  ...
  V0040Uint64NoVal? get slurmdStartTime;
  ...
  factory V0040Node([void updates(V0040NodeBuilder b)]) = _$V0040Node;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0040NodeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0040Node> get serializer => _$V0040NodeSerializer();
}

class _$V0040NodeSerializer implements PrimitiveSerializer<V0040Node> {
  @override
  final Iterable<Type> types = const [V0040Node, _$V0040Node];

  @override
  final String wireName = r'V0040Node';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.energy != null) {
      ...
      yield serializers.serialize(
        object.energy,
        specifiedType: const FullType(V0040AcctGatherEnergy),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required V0040NodeBuilder result,
  ...
  @override
  V0040Node deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0040NodeBuilder();
