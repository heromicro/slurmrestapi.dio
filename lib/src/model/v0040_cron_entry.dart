...
/// * [line] 
@BuiltValue()
abstract class V0040CronEntry implements Built<V0040CronEntry, V0040CronEntryBuilder> {
  /// Flags
  ...
  factory V0040CronEntry([void updates(V0040CronEntryBuilder b)]) = _$V0040CronEntry;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0040CronEntryBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0040CronEntry> get serializer => _$V0040CronEntrySerializer();
}

class _$V0040CronEntrySerializer implements PrimitiveSerializer<V0040CronEntry> {
  @override
  final Iterable<Type> types = const [V0040CronEntry, _$V0040CronEntry];

  @override
  final String wireName = r'V0040CronEntry';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0040CronEntry object, {
  ...
  void _deserializeProperties(
    ...
    required V0040CronEntryBuilder result,
  ...
  @override
  V0040CronEntry deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0040CronEntryBuilder();
