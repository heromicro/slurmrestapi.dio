...
import 'package:slurmrestapi/src/model/v0039_qos_limits_max.dart';
...
abstract class V0039QosLimits implements Built<V0039QosLimits, V0039QosLimitsBuilder> {
  ...
  V0039Uint32NoVal? get graceTime;

  @BuiltValueField(wireName: r'max')
  V0039QosLimitsMax? get max;
...
class _$V0039QosLimitsSerializer implements PrimitiveSerializer<V0039QosLimits> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.max != null) {
      ...
      yield serializers.serialize(
        object.max,
        specifiedType: const FullType(V0039QosLimitsMax),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        case r'grace_time':
          ...
          result.graceTime.replace(valueDes);
          break;
        case r'max':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0039QosLimitsMax),
          ) as V0039QosLimitsMax;
