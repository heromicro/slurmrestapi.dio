...
part 'v0040_openapi_tres_resp.g.dart';
...
/// * [warnings] 
@BuiltValue()
abstract class V0040OpenapiTresResp implements Built<V0040OpenapiTresResp, V0040OpenapiTresRespBuilder> {
  ...
  V0040OpenapiTresResp._();

  factory V0040OpenapiTresResp([void updates(V0040OpenapiTresRespBuilder b)]) = _$V0040OpenapiTresResp;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0040OpenapiTresRespBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0040OpenapiTresResp> get serializer => _$V0040OpenapiTresRespSerializer();
}

class _$V0040OpenapiTresRespSerializer implements PrimitiveSerializer<V0040OpenapiTresResp> {
  @override
  final Iterable<Type> types = const [V0040OpenapiTresResp, _$V0040OpenapiTresResp];

  @override
  final String wireName = r'V0040OpenapiTresResp';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0040OpenapiTresResp object, {
  ...
  void _deserializeProperties(
    ...
    required V0040OpenapiTresRespBuilder result,
  ...
  @override
  V0040OpenapiTresResp deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0040OpenapiTresRespBuilder();
