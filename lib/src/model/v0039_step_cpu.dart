...
import 'package:slurmrestapi/src/model/v0039_step_cpu_requested_frequency.dart';
...
abstract class V0039StepCPU implements Built<V0039StepCPU, V0039StepCPUBuilder> {
  ...
  V0039StepCPURequestedFrequency? get requestedFrequency;
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.requestedFrequency != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(V0039StepCPURequestedFrequency),
      );
    }
      ...
      switch (key) {
        case r'requested_frequency':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0039StepCPURequestedFrequency),
          ) as V0039StepCPURequestedFrequency;
