...
import 'package:slurmrestapi/src/model/v0039_step_statistics_cpu.dart';
...
abstract class V0039StepStatistics implements Built<V0039StepStatistics, V0039StepStatisticsBuilder> {
  ...
  V0039StepStatisticsCPU? get CPU;
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.CPU != null) {
      ...
      yield serializers.serialize(
        object.CPU,
        specifiedType: const FullType(V0039StepStatisticsCPU),
      );
    }
