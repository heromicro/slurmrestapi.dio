...
@BuiltValue()
abstract class V0037Node implements Built<V0037Node, V0037NodeBuilder> {
  ...
  factory V0037Node([void updates(V0037NodeBuilder b)]) = _$V0037Node;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0037NodeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0037Node> get serializer => _$V0037NodeSerializer();
}

class _$V0037NodeSerializer implements PrimitiveSerializer<V0037Node> {
  @override
  final Iterable<Type> types = const [V0037Node, _$V0037Node];

  @override
  final String wireName = r'V0037Node';
  ...
  void _deserializeProperties(
    ...
    required V0037NodeBuilder result,
  ...
  @override
  V0037Node deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0037NodeBuilder();
