...
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_config_resp_qos_inner_usage_factor.dart';
import 'package:built_collection/built_collection.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_config_resp_qos_inner_preempt.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_config_resp_qos_inner_priority.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_config_resp_qos_inner_limits.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_config_resp_qos_inner_usage_threshold.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'v0041_openapi_slurmdbd_config_resp_qos_inner.g.dart';
...
/// * [usageThreshold] 
@BuiltValue()
abstract class V0041OpenapiSlurmdbdConfigRespQosInner implements Built<V0041OpenapiSlurmdbdConfigRespQosInner, V0041OpenapiSlurmdbdConfigRespQosInnerBuilder> {
  ...
  V0041OpenapiSlurmdbdConfigRespQosInnerLimits? get limits;
  ...
  V0041OpenapiSlurmdbdConfigRespQosInnerPreempt? get preempt;

  @BuiltValueField(wireName: r'priority')
  V0041OpenapiSlurmdbdConfigRespQosInnerPriority? get priority;

  @BuiltValueField(wireName: r'usage_factor')
  V0041OpenapiSlurmdbdConfigRespQosInnerUsageFactor? get usageFactor;

  @BuiltValueField(wireName: r'usage_threshold')
  V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold? get usageThreshold;

  V0041OpenapiSlurmdbdConfigRespQosInner._();

  factory V0041OpenapiSlurmdbdConfigRespQosInner([void updates(V0041OpenapiSlurmdbdConfigRespQosInnerBuilder b)]) = _$V0041OpenapiSlurmdbdConfigRespQosInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041OpenapiSlurmdbdConfigRespQosInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041OpenapiSlurmdbdConfigRespQosInner> get serializer => _$V0041OpenapiSlurmdbdConfigRespQosInnerSerializer();
}

class _$V0041OpenapiSlurmdbdConfigRespQosInnerSerializer implements PrimitiveSerializer<V0041OpenapiSlurmdbdConfigRespQosInner> {
  @override
  final Iterable<Type> types = const [V0041OpenapiSlurmdbdConfigRespQosInner, _$V0041OpenapiSlurmdbdConfigRespQosInner];

  @override
  final String wireName = r'V0041OpenapiSlurmdbdConfigRespQosInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041OpenapiSlurmdbdConfigRespQosInner object, {
    ...
    if (object.limits != null) {
      ...
      yield serializers.serialize(
        object.limits,
        specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerLimits),
      );
    }
    if (object.name != null) {
      yield r'name';
    ...
    if (object.preempt != null) {
      ...
      yield serializers.serialize(
        object.preempt,
        specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerPreempt),
      );
    }
    if (object.priority != null) {
      ...
      yield serializers.serialize(
        object.priority,
        specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerPriority),
      );
    }
    if (object.usageFactor != null) {
      ...
      yield serializers.serialize(
        object.usageFactor,
        specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerUsageFactor),
      );
    }
    if (object.usageThreshold != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required V0041OpenapiSlurmdbdConfigRespQosInnerBuilder result,
      ...
      switch (key) {
        ...
        case r'limits':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerLimits),
          ) as V0041OpenapiSlurmdbdConfigRespQosInnerLimits;
        ...
        case r'preempt':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerPreempt),
          ) as V0041OpenapiSlurmdbdConfigRespQosInnerPreempt;
        ...
        case r'priority':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerPriority),
          ) as V0041OpenapiSlurmdbdConfigRespQosInnerPriority;
        ...
        case r'usage_factor':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerUsageFactor),
          ) as V0041OpenapiSlurmdbdConfigRespQosInnerUsageFactor;
        ...
        case r'usage_threshold':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold),
          ) as V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold;
  ...
  @override
  V0041OpenapiSlurmdbdConfigRespQosInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041OpenapiSlurmdbdConfigRespQosInnerBuilder();
