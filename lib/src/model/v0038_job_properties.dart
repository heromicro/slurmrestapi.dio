...
part 'v0038_job_properties.g.dart';
...
@BuiltValue()
abstract class V0038JobProperties implements Built<V0038JobProperties, V0038JobPropertiesBuilder> {
  ...
  V0038JobPropertiesExclusiveEnum? get exclusive;
  ...
  V0038JobPropertiesGresFlagsEnum? get gresFlags;
  ...
  V0038JobPropertiesOpenModeEnum? get openMode;
  ...
  V0038JobProperties._();

  factory V0038JobProperties([void updates(V0038JobPropertiesBuilder b)]) = _$V0038JobProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0038JobPropertiesBuilder b) => b
      ..openMode = const V0038JobPropertiesOpenModeEnum._('append')
      ..oversubscribe = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0038JobProperties> get serializer => _$V0038JobPropertiesSerializer();
}

class _$V0038JobPropertiesSerializer implements PrimitiveSerializer<V0038JobProperties> {
  @override
  final Iterable<Type> types = const [V0038JobProperties, _$V0038JobProperties];

  @override
  final String wireName = r'V0038JobProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0038JobProperties object, {
    ...
    if (object.exclusive != null) {
      ...
      yield serializers.serialize(
        object.exclusive,
        specifiedType: const FullType(V0038JobPropertiesExclusiveEnum),
      );
    }
    ...
    if (object.gresFlags != null) {
      ...
      yield serializers.serialize(
        object.gresFlags,
        specifiedType: const FullType(V0038JobPropertiesGresFlagsEnum),
      );
    }
    ...
    if (object.openMode != null) {
      ...
      yield serializers.serialize(
        object.openMode,
        specifiedType: const FullType(V0038JobPropertiesOpenModeEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required V0038JobPropertiesBuilder result,
      ...
      switch (key) {
        ...
        case r'exclusive':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0038JobPropertiesExclusiveEnum),
          ) as V0038JobPropertiesExclusiveEnum;
        ...
        case r'gres_flags':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0038JobPropertiesGresFlagsEnum),
          ) as V0038JobPropertiesGresFlagsEnum;
        ...
        case r'open_mode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0038JobPropertiesOpenModeEnum),
          ) as V0038JobPropertiesOpenModeEnum;
  ...
  @override
  V0038JobProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0038JobPropertiesBuilder();
...
class V0038JobPropertiesExclusiveEnum extends EnumClass {

  /// The job allocation can share nodes just other users with the \"user\" option or with the \"mcs\" option).
  @BuiltValueEnumConst(wireName: r'user')
  static const V0038JobPropertiesExclusiveEnum user = _$v0038JobPropertiesExclusiveEnum_user;
  /// The job allocation can share nodes just other users with the \"user\" option or with the \"mcs\" option).
  @BuiltValueEnumConst(wireName: r'mcs')
  static const V0038JobPropertiesExclusiveEnum mcs = _$v0038JobPropertiesExclusiveEnum_mcs;
  /// The job allocation can share nodes just other users with the \"user\" option or with the \"mcs\" option).
  @BuiltValueEnumConst(wireName: r'true')
  static const V0038JobPropertiesExclusiveEnum true_ = _$v0038JobPropertiesExclusiveEnum_true_;
  /// The job allocation can share nodes just other users with the \"user\" option or with the \"mcs\" option).
  @BuiltValueEnumConst(wireName: r'false')
  static const V0038JobPropertiesExclusiveEnum false_ = _$v0038JobPropertiesExclusiveEnum_false_;

  static Serializer<V0038JobPropertiesExclusiveEnum> get serializer => _$v0038JobPropertiesExclusiveEnumSerializer;

  const V0038JobPropertiesExclusiveEnum._(String name): super(name);

  static BuiltSet<V0038JobPropertiesExclusiveEnum> get values => _$v0038JobPropertiesExclusiveEnumValues;
  static V0038JobPropertiesExclusiveEnum valueOf(String name) => _$v0038JobPropertiesExclusiveEnumValueOf(name);
}

class V0038JobPropertiesGresFlagsEnum extends EnumClass {

  /// Specify generic resource task binding options.
  @BuiltValueEnumConst(wireName: r'disable-binding')
  static const V0038JobPropertiesGresFlagsEnum disableBinding = _$v0038JobPropertiesGresFlagsEnum_disableBinding;
  /// Specify generic resource task binding options.
  @BuiltValueEnumConst(wireName: r'enforce-binding')
  static const V0038JobPropertiesGresFlagsEnum enforceBinding = _$v0038JobPropertiesGresFlagsEnum_enforceBinding;

  static Serializer<V0038JobPropertiesGresFlagsEnum> get serializer => _$v0038JobPropertiesGresFlagsEnumSerializer;

  const V0038JobPropertiesGresFlagsEnum._(String name): super(name);

  static BuiltSet<V0038JobPropertiesGresFlagsEnum> get values => _$v0038JobPropertiesGresFlagsEnumValues;
  static V0038JobPropertiesGresFlagsEnum valueOf(String name) => _$v0038JobPropertiesGresFlagsEnumValueOf(name);
}

class V0038JobPropertiesOpenModeEnum extends EnumClass {

  /// Open the output and error files using append or truncate mode as specified.
  @BuiltValueEnumConst(wireName: r'append')
  static const V0038JobPropertiesOpenModeEnum append = _$v0038JobPropertiesOpenModeEnum_append;
  /// Open the output and error files using append or truncate mode as specified.
  @BuiltValueEnumConst(wireName: r'truncate')
  static const V0038JobPropertiesOpenModeEnum truncate = _$v0038JobPropertiesOpenModeEnum_truncate;

  static Serializer<V0038JobPropertiesOpenModeEnum> get serializer => _$v0038JobPropertiesOpenModeEnumSerializer;

  const V0038JobPropertiesOpenModeEnum._(String name): super(name);

  static BuiltSet<V0038JobPropertiesOpenModeEnum> get values => _$v0038JobPropertiesOpenModeEnumValues;
  static V0038JobPropertiesOpenModeEnum valueOf(String name) => _$v0038JobPropertiesOpenModeEnumValueOf(name);
}
