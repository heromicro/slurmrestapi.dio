...
import 'package:slurmrestapi/src/model/v0039_step_tres_consumed.dart';
import 'package:built_collection/built_collection.dart';
import 'package:slurmrestapi/src/model/v0039_tres.dart';
import 'package:slurmrestapi/src/model/v0039_step_tres_requested.dart';
...
abstract class V0039StepTres implements Built<V0039StepTres, V0039StepTresBuilder> {
  ...
  V0039StepTresRequested? get requested;

  @BuiltValueField(wireName: r'consumed')
  V0039StepTresConsumed? get consumed;
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.requested != null) {
      ...
      yield serializers.serialize(
        object.requested,
        specifiedType: const FullType(V0039StepTresRequested),
      );
    }
    if (object.consumed != null) {
      ...
      yield serializers.serialize(
        object.consumed,
        specifiedType: const FullType(V0039StepTresConsumed),
      );
    }
