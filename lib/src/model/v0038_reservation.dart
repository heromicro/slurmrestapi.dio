...
import 'package:openapi/src/model/v0038_reservation_purge_completed.dart';
import 'package:built_collection/built_collection.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'v0038_reservation.g.dart';
...
/// * [users] - List of users
@BuiltValue()
abstract class V0038Reservation implements Built<V0038Reservation, V0038ReservationBuilder> {
  /// Allowed accounts
  ...
  V0038ReservationPurgeCompleted? get purgeCompleted;
  ...
  factory V0038Reservation([void updates(V0038ReservationBuilder b)]) = _$V0038Reservation;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0038ReservationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0038Reservation> get serializer => _$V0038ReservationSerializer();
}

class _$V0038ReservationSerializer implements PrimitiveSerializer<V0038Reservation> {
  @override
  final Iterable<Type> types = const [V0038Reservation, _$V0038Reservation];

  @override
  final String wireName = r'V0038Reservation';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0038Reservation object, {
    ...
    if (object.purgeCompleted != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(V0038ReservationPurgeCompleted),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required V0038ReservationBuilder result,
      ...
      switch (key) {
        ...
        case r'purge_completed':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0038ReservationPurgeCompleted),
          ) as V0038ReservationPurgeCompleted;
  ...
  @override
  V0038Reservation deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0038ReservationBuilder();
