...
part 'v0041_openapi_job_info_resp_jobs_inner_exit_code.g.dart';
...
/// * [signal] 
@BuiltValue()
abstract class V0041OpenapiJobInfoRespJobsInnerExitCode implements Built<V0041OpenapiJobInfoRespJobsInnerExitCode, V0041OpenapiJobInfoRespJobsInnerExitCodeBuilder> {
  ...
  V0041OpenapiJobInfoRespJobsInnerExitCode._();

  factory V0041OpenapiJobInfoRespJobsInnerExitCode([void updates(V0041OpenapiJobInfoRespJobsInnerExitCodeBuilder b)]) = _$V0041OpenapiJobInfoRespJobsInnerExitCode;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041OpenapiJobInfoRespJobsInnerExitCodeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041OpenapiJobInfoRespJobsInnerExitCode> get serializer => _$V0041OpenapiJobInfoRespJobsInnerExitCodeSerializer();
}

class _$V0041OpenapiJobInfoRespJobsInnerExitCodeSerializer implements PrimitiveSerializer<V0041OpenapiJobInfoRespJobsInnerExitCode> {
  @override
  final Iterable<Type> types = const [V0041OpenapiJobInfoRespJobsInnerExitCode, _$V0041OpenapiJobInfoRespJobsInnerExitCode];

  @override
  final String wireName = r'V0041OpenapiJobInfoRespJobsInnerExitCode';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041OpenapiJobInfoRespJobsInnerExitCode object, {
  ...
  void _deserializeProperties(
    ...
    required V0041OpenapiJobInfoRespJobsInnerExitCodeBuilder result,
  ...
  @override
  V0041OpenapiJobInfoRespJobsInnerExitCode deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041OpenapiJobInfoRespJobsInnerExitCodeBuilder();
