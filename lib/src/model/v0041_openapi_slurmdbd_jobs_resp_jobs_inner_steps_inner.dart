...
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner_nodes.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner_statistics.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner_cpu.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner_tres.dart';
import 'package:built_collection/built_collection.dart';
import 'package:slurmrestapi/src/model/v0040_step_task.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner_time.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_jobs_resp_jobs_inner_exit_code.dart';
import 'package:slurmrestapi/src/model/v0041_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner_step.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'v0041_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner.g.dart';
...
/// * [tres] 
@BuiltValue()
abstract class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner implements Built<V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner, V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerBuilder> {
  @BuiltValueField(wireName: r'time')
  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTime? get time;

  @BuiltValueField(wireName: r'exit_code')
  V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode? get exitCode;

  @BuiltValueField(wireName: r'nodes')
  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerNodes? get nodes;
  ...
  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPU? get CPU;
  ...
  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatistics? get statistics;

  @BuiltValueField(wireName: r'step')
  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStep? get step;

  @BuiltValueField(wireName: r'task')
  V0040StepTask? get task;

  @BuiltValueField(wireName: r'tres')
  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTres? get tres;

  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner._();

  factory V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner([void updates(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerBuilder b)]) = _$V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner> get serializer => _$V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerSerializer();
}

class _$V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerSerializer implements PrimitiveSerializer<V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner> {
  @override
  final Iterable<Type> types = const [V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner, _$V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner];

  @override
  final String wireName = r'V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner object, {
    ...
    if (object.time != null) {
      ...
      yield serializers.serialize(
        object.time,
        specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTime),
      );
    }
    ...
    if (object.nodes != null) {
      ...
      yield serializers.serialize(
        object.nodes,
        specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerNodes),
      );
    }
    ...
    if (object.CPU != null) {
      ...
      yield serializers.serialize(
        object.CPU,
        specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPU),
      );
    }
    ...
    if (object.statistics != null) {
      ...
      yield serializers.serialize(
        object.statistics,
        specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatistics),
      );
    }
    if (object.step != null) {
      yield r'step';
      yield serializers.serialize(
        object.step,
        specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStep),
      );
    }
    if (object.task != null) {
      yield r'task';
    ...
    if (object.tres != null) {
      ...
      yield serializers.serialize(
        object.tres,
        specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTres),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerBuilder result,
      ...
      switch (key) {
        case r'time':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTime),
          ) as V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTime;
        ...
        case r'nodes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerNodes),
          ) as V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerNodes;
        ...
        case r'CPU':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPU),
          ) as V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPU;
        ...
        case r'step':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStep),
          ) as V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStep;
  ...
  @override
  V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerBuilder();
