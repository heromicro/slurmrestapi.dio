...
import 'package:slurmrestapi/src/model/dbv0039_meta_slurm.dart';
import 'package:slurmrestapi/src/model/dbv0039_meta_plugin.dart';
...
abstract class V0039Meta implements Built<V0039Meta, V0039MetaBuilder> {
  ...
  Dbv0039MetaPlugin? get plugin;

  @BuiltValueField(wireName: r'Slurm')
  Dbv0039MetaSlurm? get slurm;
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.plugin != null) {
      ...
      yield serializers.serialize(
        object.plugin,
        specifiedType: const FullType(Dbv0039MetaPlugin),
      );
    }
    if (object.slurm != null) {
      ...
      yield serializers.serialize(
        object.slurm,
        specifiedType: const FullType(Dbv0039MetaSlurm),
      );
    }
  }
