...
part 'v0040_openapi_wckey_resp.g.dart';
...
/// * [warnings] 
@BuiltValue()
abstract class V0040OpenapiWckeyResp implements Built<V0040OpenapiWckeyResp, V0040OpenapiWckeyRespBuilder> {
  ...
  V0040OpenapiWckeyResp._();

  factory V0040OpenapiWckeyResp([void updates(V0040OpenapiWckeyRespBuilder b)]) = _$V0040OpenapiWckeyResp;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0040OpenapiWckeyRespBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0040OpenapiWckeyResp> get serializer => _$V0040OpenapiWckeyRespSerializer();
}

class _$V0040OpenapiWckeyRespSerializer implements PrimitiveSerializer<V0040OpenapiWckeyResp> {
  @override
  final Iterable<Type> types = const [V0040OpenapiWckeyResp, _$V0040OpenapiWckeyResp];

  @override
  final String wireName = r'V0040OpenapiWckeyResp';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0040OpenapiWckeyResp object, {
  ...
  void _deserializeProperties(
    ...
    required V0040OpenapiWckeyRespBuilder result,
  ...
  @override
  V0040OpenapiWckeyResp deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0040OpenapiWckeyRespBuilder();
