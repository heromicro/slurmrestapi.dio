...
@BuiltValue()
abstract class V0038Partition implements Built<V0038Partition, V0038PartitionBuilder> {
  /// partition options
  ...
  @BuiltValueField(wireName: r'maximum_memory_per_cpu')
  int? get maximumMemoryPerCpu;

  /// default MB memory per allocated node
  @BuiltValueField(wireName: r'default_memory_per_node')
  int? get defaultMemoryPerNode;

  V0038Partition._();

  factory V0038Partition([void updates(V0038PartitionBuilder b)]) = _$V0038Partition;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0038PartitionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0038Partition> get serializer => _$V0038PartitionSerializer();
}

class _$V0038PartitionSerializer implements PrimitiveSerializer<V0038Partition> {
  @override
  final Iterable<Type> types = const [V0038Partition, _$V0038Partition];

  @override
  final String wireName = r'V0038Partition';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0038Partition object, {
    ...
    if (object.maximumMemoryPerCpu != null) {
      yield r'maximum_memory_per_cpu';
      yield serializers.serialize(
        object.maximumMemoryPerCpu,
        specifiedType: const FullType(int),
      );
    }
    if (object.defaultMemoryPerNode != null) {
      yield r'default_memory_per_node';
      yield serializers.serialize(
        object.defaultMemoryPerNode,
        specifiedType: const FullType(int),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required V0038PartitionBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'tres':
          ...
          break;
        case r'maximum_memory_per_cpu':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          ) as int;
          result.maximumMemoryPerCpu = valueDes;
          break;
        case r'default_memory_per_node':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          ) as int;
          result.defaultMemoryPerNode = valueDes;
          break;
        default:
          unhandled.add(key);
          unhandled.add(value);
  ...
  @override
  V0038Partition deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0038PartitionBuilder();
