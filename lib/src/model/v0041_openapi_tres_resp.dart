...
part 'v0041_openapi_tres_resp.g.dart';
...
@BuiltValue()
abstract class V0041OpenapiTresResp implements Built<V0041OpenapiTresResp, V0041OpenapiTresRespBuilder> {
  /// TRES
  ...
  V0041OpenapiTresResp._();

  factory V0041OpenapiTresResp([void updates(V0041OpenapiTresRespBuilder b)]) = _$V0041OpenapiTresResp;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0041OpenapiTresRespBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0041OpenapiTresResp> get serializer => _$V0041OpenapiTresRespSerializer();
}

class _$V0041OpenapiTresRespSerializer implements PrimitiveSerializer<V0041OpenapiTresResp> {
  @override
  final Iterable<Type> types = const [V0041OpenapiTresResp, _$V0041OpenapiTresResp];

  @override
  final String wireName = r'V0041OpenapiTresResp';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V0041OpenapiTresResp object, {
  ...
  void _deserializeProperties(
    ...
    required V0041OpenapiTresRespBuilder result,
  ...
  @override
  V0041OpenapiTresResp deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0041OpenapiTresRespBuilder();
