...
@BuiltValue()
abstract class V0040License implements Built<V0040License, V0040LicenseBuilder> {
  /// Name of the license
  ...
  factory V0040License([void updates(V0040LicenseBuilder b)]) = _$V0040License;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0040LicenseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0040License> get serializer => _$V0040LicenseSerializer();
}

class _$V0040LicenseSerializer implements PrimitiveSerializer<V0040License> {
  @override
  final Iterable<Type> types = const [V0040License, _$V0040License];

  @override
  final String wireName = r'V0040License';
  ...
  void _deserializeProperties(
    ...
    required V0040LicenseBuilder result,
  ...
  @override
  V0040License deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V0040LicenseBuilder();
