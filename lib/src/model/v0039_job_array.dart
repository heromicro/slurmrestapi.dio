...
import 'package:slurmrestapi/src/model/v0039_job_array_limits.dart';
...
abstract class V0039JobArray implements Built<V0039JobArray, V0039JobArrayBuilder> {
  ...
  V0039JobArrayLimits? get limits;

  @BuiltValueField(wireName: r'task_id')
  V0039Uint32NoVal? get taskId;
...
class _$V0039JobArraySerializer implements PrimitiveSerializer<V0039JobArray> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.limits != null) {
      ...
      yield serializers.serialize(
        object.limits,
        specifiedType: const FullType(V0039JobArrayLimits),
      );
    }
