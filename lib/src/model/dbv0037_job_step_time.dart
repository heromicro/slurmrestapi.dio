...
part 'dbv0037_job_step_time.g.dart';
...
/// * [user] 
@BuiltValue()
abstract class Dbv0037JobStepTime implements Built<Dbv0037JobStepTime, Dbv0037JobStepTimeBuilder> {
  /// Total time elapsed
  ...
  Dbv0037JobStepTime._();

  factory Dbv0037JobStepTime([void updates(Dbv0037JobStepTimeBuilder b)]) = _$Dbv0037JobStepTime;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(Dbv0037JobStepTimeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Dbv0037JobStepTime> get serializer => _$Dbv0037JobStepTimeSerializer();
}

class _$Dbv0037JobStepTimeSerializer implements PrimitiveSerializer<Dbv0037JobStepTime> {
  @override
  final Iterable<Type> types = const [Dbv0037JobStepTime, _$Dbv0037JobStepTime];

  @override
  final String wireName = r'Dbv0037JobStepTime';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    Dbv0037JobStepTime object, {
  ...
  void _deserializeProperties(
    ...
    required Dbv0037JobStepTimeBuilder result,
  ...
  @override
  Dbv0037JobStepTime deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = Dbv0037JobStepTimeBuilder();
