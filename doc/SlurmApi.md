...
# **slurmV0040DeleteJob**
> V0040OpenapiResp slurmV0040DeleteJob(jobId, signal, flags)
...
final String signal = signal_example; // String | Signal to send to Job
final String flags = flags_example; // String | Signalling flags

try {
    final response = api.slurmV0040DeleteJob(jobId, signal, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040DeleteJob: $e\n');
}
```
 ...
 **jobId** | **String**| Job ID | 
 **signal** | **String**| Signal to send to Job | [optional] 
 **flags** | **String**| Signalling flags | [optional] 
...
> V0040OpenapiKillJobsResp slurmV0040DeleteJobs(v0040KillJobsMsg)
...
final api = Slurmrestapi().getSlurmApi();
final V0040KillJobsMsg v0040KillJobsMsg = ; // V0040KillJobsMsg | Signal or cancel jobs

try {
    final response = api.slurmV0040DeleteJobs(v0040KillJobsMsg);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040DeleteJobs: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v0040KillJobsMsg** | [**V0040KillJobsMsg**](V0040KillJobsMsg.md)| Signal or cancel jobs | [optional] 
...
> V0040OpenapiResp slurmV0040DeleteNode(nodeName)
...
final api = Slurmrestapi().getSlurmApi();
final String nodeName = nodeName_example; // String | Node name

try {
    final response = api.slurmV0040DeleteNode(nodeName);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040DeleteNode: $e\n');
}
```
...
# **slurmV0040GetDiag**
> V0040OpenapiDiagResp slurmV0040GetDiag()
...
try {
    final response = api.slurmV0040GetDiag();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetDiag: $e\n');
}
```
...
# **slurmV0040GetJob**
> V0040OpenapiJobInfoResp slurmV0040GetJob(jobId, updateTime, flags)
...
final api = Slurmrestapi().getSlurmApi();
final String jobId = jobId_example; // String | Job ID
final String updateTime = updateTime_example; // String | Filter jobs since update timestamp
final String flags = flags_example; // String | Query flags

try {
    final response = api.slurmV0040GetJob(jobId, updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetJob: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **jobId** | **String**| Job ID | 
 **updateTime** | **String**| Filter jobs since update timestamp | [optional] 
...
# **slurmV0040GetJobs**
> V0040OpenapiJobInfoResp slurmV0040GetJobs(updateTime, flags)
...
try {
    final response = api.slurmV0040GetJobs(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetJobs: $e\n');
}
```
...
> V0040OpenapiJobInfoResp slurmV0040GetJobsState(updateTime, flags)
...
try {
    final response = api.slurmV0040GetJobsState(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetJobsState: $e\n');
}
```
...
> V0040OpenapiLicensesResp slurmV0040GetLicenses()
...
try {
    final response = api.slurmV0040GetLicenses();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetLicenses: $e\n');
}
```
...
# **slurmV0040GetNode**
> V0040OpenapiNodesResp slurmV0040GetNode(nodeName, updateTime, flags)
...
try {
    final response = api.slurmV0040GetNode(nodeName, updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetNode: $e\n');
}
```
...
# **slurmV0040GetNodes**
> V0040OpenapiNodesResp slurmV0040GetNodes(updateTime, flags)
...
try {
    final response = api.slurmV0040GetNodes(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetNodes: $e\n');
}
```
...
> V0040OpenapiPartitionResp slurmV0040GetPartition(partitionName, updateTime, flags)
...
final api = Slurmrestapi().getSlurmApi();
final String partitionName = partitionName_example; // String | Partition name
final String updateTime = updateTime_example; // String | Filter partitions since update timestamp
final String flags = flags_example; // String | Query flags

try {
    final response = api.slurmV0040GetPartition(partitionName, updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetPartition: $e\n');
}
```
...
> V0040OpenapiPartitionResp slurmV0040GetPartitions(updateTime, flags)
...
try {
    final response = api.slurmV0040GetPartitions(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetPartitions: $e\n');
}
```
...
# **slurmV0040GetPing**
> V0040OpenapiPingArrayResp slurmV0040GetPing()
...
try {
    final response = api.slurmV0040GetPing();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetPing: $e\n');
}
```
...
> V0040OpenapiResp slurmV0040GetReconfigure()
...
try {
    final response = api.slurmV0040GetReconfigure();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetReconfigure: $e\n');
}
```
...
> V0040OpenapiReservationResp slurmV0040GetReservation(reservationName, updateTime)
...
final api = Slurmrestapi().getSlurmApi();
final String reservationName = reservationName_example; // String | Reservation name
final String updateTime = updateTime_example; // String | Filter reservations since update timestamp

try {
    final response = api.slurmV0040GetReservation(reservationName, updateTime);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetReservation: $e\n');
}
```
...
> V0040OpenapiReservationResp slurmV0040GetReservations(updateTime)
...
try {
    final response = api.slurmV0040GetReservations(updateTime);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetReservations: $e\n');
}
```
...
# **slurmV0040GetShares**
> V0040OpenapiSharesResp slurmV0040GetShares(accounts, users)
...
final api = Slurmrestapi().getSlurmApi();
final String accounts = accounts_example; // String | Accounts to query
final String users = users_example; // String | Users to query

try {
    final response = api.slurmV0040GetShares(accounts, users);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040GetShares: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **accounts** | **String**| Accounts to query | [optional] 
 **users** | **String**| Users to query | [optional] 
...
# **slurmV0040PostJob**
> V0040OpenapiJobPostResponse slurmV0040PostJob(jobId, v0040JobDescMsg)
...
final api = Slurmrestapi().getSlurmApi();
final String jobId = jobId_example; // String | Job ID
final V0040JobDescMsg v0040JobDescMsg = ; // V0040JobDescMsg | Job update description

try {
    final response = api.slurmV0040PostJob(jobId, v0040JobDescMsg);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040PostJob: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **jobId** | **String**| Job ID | 
 **v0040JobDescMsg** | [**V0040JobDescMsg**](V0040JobDescMsg.md)| Job update description | [optional] 
...
> V0040OpenapiJobSubmitResponse slurmV0040PostJobSubmit(v0040JobSubmitReq)
...
final api = Slurmrestapi().getSlurmApi();
final V0040JobSubmitReq v0040JobSubmitReq = ; // V0040JobSubmitReq | Job description

try {
    final response = api.slurmV0040PostJobSubmit(v0040JobSubmitReq);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040PostJobSubmit: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v0040JobSubmitReq** | [**V0040JobSubmitReq**](V0040JobSubmitReq.md)| Job description | [optional] 
...
# **slurmV0040PostNode**
> V0040OpenapiResp slurmV0040PostNode(nodeName, v0040UpdateNodeMsg)
...
final api = Slurmrestapi().getSlurmApi();
final String nodeName = nodeName_example; // String | Node name
final V0040UpdateNodeMsg v0040UpdateNodeMsg = ; // V0040UpdateNodeMsg | Node update description

try {
    final response = api.slurmV0040PostNode(nodeName, v0040UpdateNodeMsg);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0040PostNode: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **nodeName** | **String**| Node name | 
 **v0040UpdateNodeMsg** | [**V0040UpdateNodeMsg**](V0040UpdateNodeMsg.md)| Node update description | [optional] 
...
# **slurmV0041DeleteJob**
> V0041OpenapiResp slurmV0041DeleteJob(jobId, signal, flags)
...
try {
    final response = api.slurmV0041DeleteJob(jobId, signal, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041DeleteJob: $e\n');
}
```
...
> V0041OpenapiKillJobsResp slurmV0041DeleteJobs(v0041KillJobsMsg)
...
final api = Slurmrestapi().getSlurmApi();
final V0041KillJobsMsg v0041KillJobsMsg = ; // V0041KillJobsMsg | Signal or cancel jobs

try {
    final response = api.slurmV0041DeleteJobs(v0041KillJobsMsg);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041DeleteJobs: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v0041KillJobsMsg** | [**V0041KillJobsMsg**](V0041KillJobsMsg.md)| Signal or cancel jobs | [optional] 
...
> V0041OpenapiResp slurmV0041DeleteNode(nodeName)
...
try {
    final response = api.slurmV0041DeleteNode(nodeName);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041DeleteNode: $e\n');
}
```
...
# **slurmV0041GetDiag**
> V0041OpenapiDiagResp slurmV0041GetDiag()
...
try {
    final response = api.slurmV0041GetDiag();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetDiag: $e\n');
}
```
...
# **slurmV0041GetJob**
> V0041OpenapiJobInfoResp slurmV0041GetJob(jobId, updateTime, flags)
...
try {
    final response = api.slurmV0041GetJob(jobId, updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetJob: $e\n');
}
```
...
# **slurmV0041GetJobs**
> V0041OpenapiJobInfoResp slurmV0041GetJobs(updateTime, flags)
...
try {
    final response = api.slurmV0041GetJobs(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetJobs: $e\n');
}
```
...
> V0041OpenapiJobInfoResp slurmV0041GetJobsState(updateTime, flags)
...
try {
    final response = api.slurmV0041GetJobsState(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetJobsState: $e\n');
}
```
...
> V0041OpenapiLicensesResp slurmV0041GetLicenses()
...
try {
    final response = api.slurmV0041GetLicenses();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetLicenses: $e\n');
}
```
...
# **slurmV0041GetNode**
> V0041OpenapiNodesResp slurmV0041GetNode(nodeName, updateTime, flags)
...
try {
    final response = api.slurmV0041GetNode(nodeName, updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetNode: $e\n');
}
```
...
# **slurmV0041GetNodes**
> V0041OpenapiNodesResp slurmV0041GetNodes(updateTime, flags)
...
try {
    final response = api.slurmV0041GetNodes(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetNodes: $e\n');
}
```
...
> V0041OpenapiPartitionResp slurmV0041GetPartition(partitionName, updateTime, flags)
...
try {
    final response = api.slurmV0041GetPartition(partitionName, updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetPartition: $e\n');
}
```
...
> V0041OpenapiPartitionResp slurmV0041GetPartitions(updateTime, flags)
...
try {
    final response = api.slurmV0041GetPartitions(updateTime, flags);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetPartitions: $e\n');
}
```
...
# **slurmV0041GetPing**
> V0041OpenapiPingArrayResp slurmV0041GetPing()
...
try {
    final response = api.slurmV0041GetPing();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetPing: $e\n');
}
```
...
> V0041OpenapiResp slurmV0041GetReconfigure()
...
try {
    final response = api.slurmV0041GetReconfigure();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetReconfigure: $e\n');
}
```
...
> V0041OpenapiReservationResp slurmV0041GetReservation(reservationName, updateTime)
...
try {
    final response = api.slurmV0041GetReservation(reservationName, updateTime);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetReservation: $e\n');
}
```
...
> V0041OpenapiReservationResp slurmV0041GetReservations(updateTime)
...
try {
    final response = api.slurmV0041GetReservations(updateTime);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetReservations: $e\n');
}
```
...
# **slurmV0041GetShares**
> V0041OpenapiSharesResp slurmV0041GetShares(accounts, users)
...
try {
    final response = api.slurmV0041GetShares(accounts, users);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041GetShares: $e\n');
}
```
...
# **slurmV0041PostJob**
> V0041OpenapiJobPostResponse slurmV0041PostJob(jobId, v0041JobDescMsg)
...
final api = Slurmrestapi().getSlurmApi();
final String jobId = jobId_example; // String | Job ID
final V0041JobDescMsg v0041JobDescMsg = ; // V0041JobDescMsg | Job update description

try {
    final response = api.slurmV0041PostJob(jobId, v0041JobDescMsg);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041PostJob: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **jobId** | **String**| Job ID | 
 **v0041JobDescMsg** | [**V0041JobDescMsg**](V0041JobDescMsg.md)| Job update description | [optional] 
...
> V0041OpenapiJobAllocResp slurmV0041PostJobAllocate(v0041JobAllocReq)
...
final api = Slurmrestapi().getSlurmApi();
final V0041JobAllocReq v0041JobAllocReq = ; // V0041JobAllocReq | Job allocation description

try {
    final response = api.slurmV0041PostJobAllocate(v0041JobAllocReq);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041PostJobAllocate: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v0041JobAllocReq** | [**V0041JobAllocReq**](V0041JobAllocReq.md)| Job allocation description | [optional] 
...
> V0041OpenapiJobSubmitResponse slurmV0041PostJobSubmit(v0041JobSubmitReq)
...
final api = Slurmrestapi().getSlurmApi();
final V0041JobSubmitReq v0041JobSubmitReq = ; // V0041JobSubmitReq | Job description

try {
    final response = api.slurmV0041PostJobSubmit(v0041JobSubmitReq);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041PostJobSubmit: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v0041JobSubmitReq** | [**V0041JobSubmitReq**](V0041JobSubmitReq.md)| Job description | [optional] 
...
# **slurmV0041PostNode**
> V0041OpenapiResp slurmV0041PostNode(nodeName, v0041UpdateNodeMsg)
...
final api = Slurmrestapi().getSlurmApi();
final String nodeName = nodeName_example; // String | Node name
final V0041UpdateNodeMsg v0041UpdateNodeMsg = ; // V0041UpdateNodeMsg | Node update description

try {
    final response = api.slurmV0041PostNode(nodeName, v0041UpdateNodeMsg);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SlurmApi->slurmV0041PostNode: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **nodeName** | **String**| Node name | 
 **v0041UpdateNodeMsg** | [**V0041UpdateNodeMsg**](V0041UpdateNodeMsg.md)| Node update description | [optional] 
