...
// tests for V0041JobDescMsg
void main() {
  final instance = V0041JobDescMsgBuilder();
  // TODO add properties to the builder and call build()

  group(V0041JobDescMsg, () {
    ...
    // V0041JobDescMsgBeginTime beginTime
    ...
    // V0041JobDescMsgCrontab crontab
    ...
    // V0041JobDescMsgRlimits rlimits
    ...
    // V0041JobDescMsgDistributionPlaneSize distributionPlaneSize
    ...
    // int resvMpiPorts
    test('to test the property `resvMpiPorts`', () async {
      // TODO
    });
    ...
    // V0041JobDescMsgKillWarningDelay killWarningDelay
    ...
    // V0041JobDescMsgMemoryPerCpu memoryPerNode
    ...
    // V0041JobDescMsgRequiredSwitches requiredSwitches
    test('to test the property `requiredSwitches`', () async {
      // TODO
    });

    // V0041JobDescMsgSegmentSize segmentSize
    test('to test the property `segmentSize`', () async {
      // TODO
    });
