...
// tests for Dbv0037JobStepTime
void main() {
  final instance = Dbv0037JobStepTimeBuilder();
  // TODO add properties to the builder and call build()

  group(Dbv0037JobStepTime, () {
    // Total time elapsed
    // int elapsed
    ...
    // Dbv0037JobTimeSystem system
    test('to test the property `system`', () async {
      // TODO
    });

    // Dbv0037JobTimeTotal total
    test('to test the property `total`', () async {
      // TODO
    });

    // Dbv0037JobTimeUser user
