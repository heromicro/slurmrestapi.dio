...
void main() {
  ...
  group(SlurmApi, () {
    ...
    // cancel or signal job
    //
    //Future<V0040OpenapiResp> slurmV0040DeleteJob(String jobId, { String signal, String flags }) async
    test('test slurmV0040DeleteJob', () async {
      // TODO
    });

    // send signal to list of jobs
    //
    //Future<V0040OpenapiKillJobsResp> slurmV0040DeleteJobs({ V0040KillJobsMsg v0040KillJobsMsg }) async
    test('test slurmV0040DeleteJobs', () async {
      // TODO
    });

    // delete node
    //
    //Future<V0040OpenapiResp> slurmV0040DeleteNode(String nodeName) async
    test('test slurmV0040DeleteNode', () async {
      // TODO
    });

    // get diagnostics
    //
    //Future<V0040OpenapiDiagResp> slurmV0040GetDiag() async
    test('test slurmV0040GetDiag', () async {
      // TODO
    });

    // get job info
    //
    //Future<V0040OpenapiJobInfoResp> slurmV0040GetJob(String jobId, { String updateTime, String flags }) async
    test('test slurmV0040GetJob', () async {
      // TODO
    });

    // get list of jobs
    //
    //Future<V0040OpenapiJobInfoResp> slurmV0040GetJobs({ String updateTime, String flags }) async
    test('test slurmV0040GetJobs', () async {
      // TODO
    });

    // get list of job states
    //
    //Future<V0040OpenapiJobInfoResp> slurmV0040GetJobsState({ String updateTime, String flags }) async
    test('test slurmV0040GetJobsState', () async {
      // TODO
    });

    // get all Slurm tracked license info
    //
    //Future<V0040OpenapiLicensesResp> slurmV0040GetLicenses() async
    test('test slurmV0040GetLicenses', () async {
      // TODO
    });

    // get node info
    //
    //Future<V0040OpenapiNodesResp> slurmV0040GetNode(String nodeName, { String updateTime, String flags }) async
    test('test slurmV0040GetNode', () async {
      // TODO
    });

    // get node(s) info
    //
    //Future<V0040OpenapiNodesResp> slurmV0040GetNodes({ String updateTime, String flags }) async
    test('test slurmV0040GetNodes', () async {
      // TODO
    });

    // get partition info
    //
    //Future<V0040OpenapiPartitionResp> slurmV0040GetPartition(String partitionName, { String updateTime, String flags }) async
    test('test slurmV0040GetPartition', () async {
      // TODO
    });

    // get all partition info
    //
    //Future<V0040OpenapiPartitionResp> slurmV0040GetPartitions({ String updateTime, String flags }) async
    test('test slurmV0040GetPartitions', () async {
      // TODO
    });

    // ping test
    //
    //Future<V0040OpenapiPingArrayResp> slurmV0040GetPing() async
    test('test slurmV0040GetPing', () async {
      // TODO
    });

    // request slurmctld reconfigure
    //
    //Future<V0040OpenapiResp> slurmV0040GetReconfigure() async
    test('test slurmV0040GetReconfigure', () async {
      // TODO
    });

    // get reservation info
    //
    //Future<V0040OpenapiReservationResp> slurmV0040GetReservation(String reservationName, { String updateTime }) async
    test('test slurmV0040GetReservation', () async {
      // TODO
    });

    // get all reservation info
    //
    //Future<V0040OpenapiReservationResp> slurmV0040GetReservations({ String updateTime }) async
    test('test slurmV0040GetReservations', () async {
      // TODO
    });

    // get fairshare info
    //
    //Future<V0040OpenapiSharesResp> slurmV0040GetShares({ String accounts, String users }) async
    test('test slurmV0040GetShares', () async {
      // TODO
    });

    // update job
    //
    //Future<V0040OpenapiJobPostResponse> slurmV0040PostJob(String jobId, { V0040JobDescMsg v0040JobDescMsg }) async
    test('test slurmV0040PostJob', () async {
      // TODO
    });

    // submit new job
    //
    //Future<V0040OpenapiJobSubmitResponse> slurmV0040PostJobSubmit({ V0040JobSubmitReq v0040JobSubmitReq }) async
    test('test slurmV0040PostJobSubmit', () async {
      // TODO
    });

    // update node properties
    //
    //Future<V0040OpenapiResp> slurmV0040PostNode(String nodeName, { V0040UpdateNodeMsg v0040UpdateNodeMsg }) async
    test('test slurmV0040PostNode', () async {
      // TODO
    });

    // cancel or signal job
    //
    //Future<V0041OpenapiResp> slurmV0041DeleteJob(String jobId, { String signal, String flags }) async
    test('test slurmV0041DeleteJob', () async {
      // TODO
    });

    // send signal to list of jobs
    //
    //Future<V0041OpenapiKillJobsResp> slurmV0041DeleteJobs({ V0041KillJobsMsg v0041KillJobsMsg }) async
    test('test slurmV0041DeleteJobs', () async {
      // TODO
    });

    // delete node
    //
    //Future<V0041OpenapiResp> slurmV0041DeleteNode(String nodeName) async
    test('test slurmV0041DeleteNode', () async {
      // TODO
    });

    // get diagnostics
    //
    //Future<V0041OpenapiDiagResp> slurmV0041GetDiag() async
    test('test slurmV0041GetDiag', () async {
      // TODO
    });

    // get job info
    //
    //Future<V0041OpenapiJobInfoResp> slurmV0041GetJob(String jobId, { String updateTime, String flags }) async
    test('test slurmV0041GetJob', () async {
      // TODO
    });

    // get list of jobs
    //
    //Future<V0041OpenapiJobInfoResp> slurmV0041GetJobs({ String updateTime, String flags }) async
    test('test slurmV0041GetJobs', () async {
      // TODO
    });

    // get list of job states
    //
    //Future<V0041OpenapiJobInfoResp> slurmV0041GetJobsState({ String updateTime, String flags }) async
    test('test slurmV0041GetJobsState', () async {
      // TODO
    });

    // get all Slurm tracked license info
    //
    //Future<V0041OpenapiLicensesResp> slurmV0041GetLicenses() async
    test('test slurmV0041GetLicenses', () async {
      // TODO
    });

    // get node info
    //
    //Future<V0041OpenapiNodesResp> slurmV0041GetNode(String nodeName, { String updateTime, String flags }) async
    test('test slurmV0041GetNode', () async {
      // TODO
    });

    // get node(s) info
    //
    //Future<V0041OpenapiNodesResp> slurmV0041GetNodes({ String updateTime, String flags }) async
    test('test slurmV0041GetNodes', () async {
      // TODO
    });

    // get partition info
    //
    //Future<V0041OpenapiPartitionResp> slurmV0041GetPartition(String partitionName, { String updateTime, String flags }) async
    test('test slurmV0041GetPartition', () async {
      // TODO
    });

    // get all partition info
    //
    //Future<V0041OpenapiPartitionResp> slurmV0041GetPartitions({ String updateTime, String flags }) async
    test('test slurmV0041GetPartitions', () async {
      // TODO
    });

    // ping test
    //
    //Future<V0041OpenapiPingArrayResp> slurmV0041GetPing() async
    test('test slurmV0041GetPing', () async {
      // TODO
    });

    // request slurmctld reconfigure
    //
    //Future<V0041OpenapiResp> slurmV0041GetReconfigure() async
    test('test slurmV0041GetReconfigure', () async {
      // TODO
    });

    // get reservation info
    //
    //Future<V0041OpenapiReservationResp> slurmV0041GetReservation(String reservationName, { String updateTime }) async
    test('test slurmV0041GetReservation', () async {
      // TODO
    });

    // get all reservation info
    //
    //Future<V0041OpenapiReservationResp> slurmV0041GetReservations({ String updateTime }) async
    test('test slurmV0041GetReservations', () async {
      // TODO
    });

    // get fairshare info
    //
    //Future<V0041OpenapiSharesResp> slurmV0041GetShares({ String accounts, String users }) async
    test('test slurmV0041GetShares', () async {
      // TODO
    });

    // update job
    //
    //Future<V0041OpenapiJobPostResponse> slurmV0041PostJob(String jobId, { V0041JobDescMsg v0041JobDescMsg }) async
    test('test slurmV0041PostJob', () async {
      // TODO
    });

    // submit new job allocation without any steps that must be signaled to stop
    //
    //Future<V0041OpenapiJobAllocResp> slurmV0041PostJobAllocate({ V0041JobAllocReq v0041JobAllocReq }) async
    test('test slurmV0041PostJobAllocate', () async {
      // TODO
    });

    // submit new job
    //
    //Future<V0041OpenapiJobSubmitResponse> slurmV0041PostJobSubmit({ V0041JobSubmitReq v0041JobSubmitReq }) async
    test('test slurmV0041PostJobSubmit', () async {
      // TODO
    });

    // update node properties
    //
    //Future<V0041OpenapiResp> slurmV0041PostNode(String nodeName, { V0041UpdateNodeMsg v0041UpdateNodeMsg }) async
    test('test slurmV0041PostNode', () async {
      // TODO
    });
