...
// tests for V0038JobResponseProperties
void main() {
  final instance = V0038JobResponsePropertiesBuilder();
  // TODO add properties to the builder and call build()

  group(V0038JobResponseProperties, () {
    ...
    // V0038JobResources jobResources
