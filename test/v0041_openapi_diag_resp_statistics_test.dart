...
// tests for V0041OpenapiDiagRespStatistics
void main() {
  final instance = V0041OpenapiDiagRespStatisticsBuilder();
  // TODO add properties to the builder and call build()

  group(V0041OpenapiDiagRespStatistics, () {
    ...
    // V0041OpenapiDiagRespStatisticsReqTime reqTime
    test('to test the property `reqTime`', () async {
      // TODO
    });

    // V0041OpenapiDiagRespStatisticsReqTimeStart reqTimeStart
    ...
    // int scheduleCycleSum
    test('to test the property `scheduleCycleSum`', () async {
      // TODO
    });
    ...
    // int scheduleCycleDepth
    test('to test the property `scheduleCycleDepth`', () async {
      // TODO
    });

    // V0041OpenapiDiagRespStatisticsScheduleExit scheduleExit
    ...
    // V0041OpenapiDiagRespStatisticsJobStatesTs jobStatesTs
    ...
    // int bfCycleMax
    test('to test the property `bfCycleMax`', () async {
      // TODO
    });

    // V0041OpenapiDiagRespStatisticsBfExit bfExit
    ...
    // int bfTableSizeSum
    test('to test the property `bfTableSizeSum`', () async {
      // TODO
    });
    ...
    // V0041OpenapiDiagRespStatisticsBfWhenLastCycle bfWhenLastCycle
    ...
    // BuiltList<V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInner> rpcsByMessageType
    test('to test the property `rpcsByMessageType`', () async {
      // TODO
    });

    // RPCs issued by user ID
    // BuiltList<V0041OpenapiDiagRespStatisticsRpcsByUserInner> rpcsByUser
    test('to test the property `rpcsByUser`', () async {
      // TODO
    });

    // Pending RPC statistics
    // BuiltList<V0041OpenapiDiagRespStatisticsPendingRpcsInner> pendingRpcs
    test('to test the property `pendingRpcs`', () async {
      // TODO
    });

    // Pending RPCs hostlists
    // BuiltList<V0041OpenapiDiagRespStatisticsPendingRpcsByHostlistInner> pendingRpcsByHostlist
    test('to test the property `pendingRpcsByHostlist`', () async {
      // TODO
    });
