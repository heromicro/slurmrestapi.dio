...
// tests for V0038DiagStatistics
void main() {
  final instance = V0038DiagStatisticsBuilder();
  // TODO add properties to the builder and call build()

  group(V0038DiagStatistics, () {
    ...
    // BuiltList<V0038DiagRpcm> rpcsByMessageType
    test('to test the property `rpcsByMessageType`', () async {
      // TODO
    });

    // Remote Procedure Call statistics by user
    // BuiltList<V0038DiagRpcu> rpcsByUser
