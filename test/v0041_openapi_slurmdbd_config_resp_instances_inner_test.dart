...
// tests for V0041OpenapiSlurmdbdConfigRespInstancesInner
void main() {
  final instance = V0041OpenapiSlurmdbdConfigRespInstancesInnerBuilder();
  // TODO add properties to the builder and call build()

  group(V0041OpenapiSlurmdbdConfigRespInstancesInner, () {
    // Cluster name
    // String cluster
