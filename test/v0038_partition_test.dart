...
// tests for V0038Partition
void main() {
  final instance = V0038PartitionBuilder();
  // TODO add properties to the builder and call build()

  group(V0038Partition, () {
    // partition options
    ...
    // int maximumMemoryPerCpu
    test('to test the property `maximumMemoryPerCpu`', () async {
      // TODO
    });

    // default MB memory per allocated node
    // int defaultMemoryPerNode
    test('to test the property `defaultMemoryPerNode`', () async {
      // TODO
    });
