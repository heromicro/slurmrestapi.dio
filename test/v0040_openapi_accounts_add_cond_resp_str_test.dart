...
// tests for V0040OpenapiAccountsAddCondRespStr
void main() {
  final instance = V0040OpenapiAccountsAddCondRespStrBuilder();
  // TODO add properties to the builder and call build()

  group(V0040OpenapiAccountsAddCondRespStr, () {
    // added_accounts
    // String addedAccounts
    test('to test the property `addedAccounts`', () async {
      // TODO
    });
